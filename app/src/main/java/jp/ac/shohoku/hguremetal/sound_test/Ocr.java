...
import tesseractsample.tools.RequestPermissionsTool;
import tesseractsample.tools.RequestPermissionsToolImpl;

public class Ocr extends Activity implements ActivityCompat.OnRequestPermissionsResultCallback  {
